...
pub fn seed_command_pool(conn: &mut Connection) -> Result<usize, String> {
    ...
    let commands: Vec<(&str, &str, &str, &str)> = vec![
        ...
        ("H3C", "display device manuinfo | include Serial", "查看序列号", "hardware"),
        // ==================== 华为 (Huawei) ====================
        ...
        ("华为", "display device manuinfo", "查看设备序列号", "hardware"),
        ...
        ("锐捷", "show device manuinfo", "查看设备序列号", "hardware"),
